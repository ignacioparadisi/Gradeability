...
class TermDetailViewController: UIViewController {
    ...
    // MARK: Initializers
    init(_ viewModel: TermDetailViewModel) {
...
extension TermDetailViewController: UITableViewDelegate {
...
extension TermDetailViewController: UIAdaptivePresentationControllerDelegate {
...
extension TermDetailViewController: UIGestureRecognizerDelegate {
